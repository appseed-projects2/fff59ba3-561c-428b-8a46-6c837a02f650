...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-26 11:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/fff59ba3-561c-428b-8a46-6c837a02f650.git
$ cd fff59ba3-561c-428b-8a46-6c837a02f650
```
